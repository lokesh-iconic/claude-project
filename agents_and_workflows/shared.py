"""
shared.py — Shared types, constants, and formatting rules used by both the
workflow and the agent implementations.

Design decision: Pydantic models enforce schema consistency across both systems
so the comparison runner can diff outputs structurally, not just by string.
"""
